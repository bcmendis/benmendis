  ...
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
        ...
        right:
          "flex-col inset-y-0 right-0 h-full w-1/2 border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-sm",
      },
    },
    defaultVariants: {
      side: "right",
...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal className="flex-col">
    ...
    <SheetPrimitive.Content
      ...
      {...props}
    >
      <div className="flex w-full mb-5 justify-end items-end">
